...
{
     $content = $this->lsetting->franchise();
        $this->template_lib->full_website_html_view($content);
}

public function all_products()
{
     $content = $this->lsetting->all_products();
        $this->template_lib->full_website_html_view($content);
}
...
public function submit_franchise()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                'franchise_id' => $this->auth->generator(15),
                'first_name' => $this->input->post('first_name',TRUE),
                'last_name' => $this->input->post('last_name',TRUE),
                'email' => $this->input->post('email',TRUE),
            ...
            $result = $this->Settings->submit_franchise($data);
