        ...
        <div class="col-lg-9 mainContent category-content">
            ...
            <div class="row">
                ...
                $brand_product = array_slice($brand_product, $offset, $limit);
					...
					if ($user_type == 6) {
						if ($brand_product) {
							foreach ($brand_product as $key => $retail_product) {
								
								$brand_product[$key]['price'] = $retail_product['retail_price'];
							}
						}
					}
					//7 is wholesaler 
					if ($user_type == 7) {
						if ($brand_product) {
							foreach ($brand_product as $key => $whole_product) {
								$brand_product[$key]['price'] = $whole_product['wholesale_price'];
							}
						}
					}
