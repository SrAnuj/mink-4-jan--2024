...
<div class="container pb-5">
    ...
    <nav aria-label="breadcrumb" class="my-4">
        <ol class="breadcrumb d-inline-flex mb-0">
            ...
            <li class="breadcrumb-item align-items-center active"><a href="<?php echo base_url('checkout') ?>"
                    class="d-flex align-items-center"><?php echo display('checkout') ?></a></li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col-md-8 mainContent">
            ...
            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" id="login_password" class="form-control"
                                                    name="login_password" value="<?php echo get_cookie("password"); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            ...
                                            <a href="#"
                                                class="btn btn-success color4 color46 customer_login"><?php echo display('login') ?></a>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-12 social_login">
                                                <?php if((check_module_status('facebooklogin') == 1)){
                                                    ?>&nbsp; OR &nbsp;
                                                <a class="btn btn-facebook btn-sm  search text-white"
                                                    href="<?php echo base_url('facebooklogin/facebooklogin/index/1')?>"><i
                                                        class="fab fa-facebook-square"></i>
                                                    <?php echo display('facebook_login')?></a>
                                                <?php }?>
                                                <?php if((check_module_status('linkedinlogin') == 1)){ ?>
                                                &nbsp; OR &nbsp;
                                                <a class="btn btn-linkedin btn-sm  search text-white"
                                                    href="<?php echo base_url('linkedinlogin/linkedinlogin/login/1')?>"><i
                                                        class="fab fa-linkedin"></i>
                                                    <?php echo display('linkedin_login')?></a>
                                                <?php }?>
                                                <?php if(check_module_status('googlelogin') == 1){ 
                                                    ?>&nbsp; OR &nbsp;
                                                <a class="btn btn-google btn-sm  search text-white"
                                                    href="<?php echo base_url('googlelogin/googlelogin/login')?>"><i
                                        ...
                                        <div class="col-sm-12">
                                            <a href="<?php echo base_url('logout') ?>"
                                                class="btn btn-danger btn-sm "><?php echo display('logout') ?></a>
                                        </div>
                                        <?php } ?>
                                    </div>
                                    <hr>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="font-weight-500" for="first_name"><?php echo display('first_name') ?><span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="first_name" id="first_name"
                            placeholder="<?php echo display('first_name') ?>"
                            value="<?php echo set_value('first_name', $this->session->userdata('first_name')) ?>"
                            required>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="font-weight-500" for="last_name"><?php echo display('last_name') ?><span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="last_name" id="last_name"
                            placeholder="<?php echo display('last_name') ?>"
                            value="<?php echo set_value('last_name', $this->session->userdata('last_name')) ?>">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="font-weight-500"
                            for="customer_email"><?php echo display('customer_email') ?><span
                                class="text-danger">*</span></label>
                        <input type="text" name="customer_email" id="customer_email"
                            placeholder="<?php echo display('customer_email') ?>" class="form-control"
                            value="<?php echo set_value('customer_email', $this->session->userdata('customer_email')) ?>">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="font-weight-500"
                            for="customer_mobile"><?php echo display('customer_mobile') ?><span
                                class="text-danger">*</span></label>
                        <input type="number" id="customer_mobile" class="form-control" name="customer_mobile"
                            placeholder="<?php echo display('customer_mobile') ?>" required
                            value="<?php echo set_value('customer_mobile', $this->session->userdata('customer_mobile')) ?>"
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="font-weight-500" for="country"><?php echo display('country') ?><span
                                class="text-danger">*</span></label>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="font-weight-500"
                            for="customer_address_1"><?php echo display('customer_address_1') ?><span
                                class="text-danger">*</span></label>
                        <input type="text" placeholder="<?php echo display('customer_address_1') ?>"
                            name="customer_address_1" id="customer_address_1" class="form-control" required
                            value="<?php echo set_value('customer_address_1', $this->session->userdata('customer_address_1')) ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="font-weight-500" for="state"><?php echo display('state') ?><span
                                class="text-danger">*</span></label>
                        <select name="state" id="state" class="form-control" required>
                            ...
                            <option value="<?php echo remove_space($state->name); ?>" <?php if (remove_space($this->session->userdata('state')) == remove_space($state->name)) {
                                        echo "selected";
                                    } ?> data-id="<?= $state->id ?>"><?php echo html_escape($state->name) ?> </option>
                            <?php
                                }
                            }
                            ?>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="font-weight-500"
                            for="customer_address_2"><?php echo display('customer_address_2') ?></label>
                        <input type="text" name="customer_address_2" id="customer_address_2"
                            placeholder="<?php echo display('customer_address_2') ?>" class="form-control"
                            value="<?php echo set_value('customer_address_2', $this->session->userdata('customer_address_2')) ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="font-weight-500" for="state"><?php echo display('city') ?><span
                                class="text-danger">*</span></label>
                        <select name="city" id="city_id" class="form-control" required>
                            <option value=""> --- <?php echo display('City') ?> ---</option>
                            <?php
                            if ($city_lists) {
                                foreach ($city_lists as $city) {
                                    ?>
                            <option value="<?php echo remove_space($city->name); ?>" <?php if (remove_space($this->session->userdata('city')) == remove_space($city->name)) {
                                        echo "selected";
                                    } ?> data-id="<?= $city->id ?>"><?php echo html_escape($city->name) ?> </option>
                            <?php
                                }
                            }
                            ?>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="zip" id="zip" placeholder="<?php echo display('zip') ?>"
                            class="form-control"
                            value="<?php echo set_value('zip', $this->session->userdata('zip')) ?>">
                    </div>
                </div>
            </div>
            <?php
            ...
            <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label" for="creat_ac" data-toggle="collapse"
                    data-target="#account-pass"><?php echo display('create_account') ?></label>
            </div>
            <div class="collapse" id="account-pass">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="font-weight-500" for="ac_pass"><?php echo display('password') ?><span
                                    class="text-danger">*</span></label>
                            <input type="text" name="ac_pass" id="password-field"
                                placeholder="<?php echo display('password') ?>" class="form-control" required
                                value="<?php echo set_value('ac_pass', $this->session->userdata('ac_pass')) ?>">
            ...
            <div class="custom-control custom-checkbox">
                <input class="custom-control-input" type="checkbox" id="privacy_policy" name="privacy_policy" value="1"
                    required="" <?php if ($this->session->userdata('privacy_policy') == 1) {
                        echo "checked";
                    } ?>>
                <label class="custom-control-label" for="privacy_policy"><?php echo display('privacy_policy') ?><span
                        class="text-danger">*</span> <a href="<?php echo base_url('privacy_policy') ?>"
                        target="_blank"><i class="fa fa-external-link"></i></a></label>
            </div>

            <div class="custom-control custom-checkbox">
                <input class="custom-control-input" type="checkbox" id="diff_ship_adrs" name="diff_ship_adrs" value="1"
                    <?php if ($this->session->userdata('diff_ship_adrs') == 1) { echo "checked"; } ?>>
                <label class="custom-control-label" for="diff_ship_adrs" data-toggle="collapse"
            ...
            <div class="collapse <?php if ($this->session->userdata('diff_ship_adrs') == 1) {
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ship_first_name" id="ship_first_name"
                                placeholder="<?php echo display('first_name') ?>" class="form-control" required
                                value="<?php echo set_value('ship_first_name', $this->session->userdata('ship_first_name')) ?>">
                        </div>

                        <div class="form-group">
                            <label class="font-weight-500"
                                for="ship_customer_email"><?php echo display('customer_email') ?></label>
                            <input type="text" id="ship_customer_email" name="ship_customer_email" class="form-control"
                                placeholder="<?php echo display('customer_email') ?>"
                                value="<?php echo $this->session->userdata('ship_email') ?>">
                        </div>
                        <div class="form-group">
                            <label for="ship_country" class="control-label"><?php echo display('country') ?><span
                                    class="text-danger">*</span> </label>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="ship_state"><?php echo display('state') ?> <span
                                    class="text-danger">*</span></label>
                            <select name="ship_state" id="ship_state" class="form-control">
                                ...
                                <option value="<?php echo html_escape($ship_state->name) ?>" <?php if ($this->session->userdata('ship_state') == $ship_state->name) {
                                                echo "selected";
                                            } ?> data-id="<?= $ship_state->id ?>"><?php echo html_escape($ship_state->name) ?> </option>
                                <?php
                                        }
                                    }
                                    ?>
                        ...
                        <div class="form-group">
                            <label for="ship_city" class="font-weight-500"><?php echo display('city') ?> <span
                                    class="text-danger">*</span></label>
                            
                            <select name="ship_city" id="ship_city" class="form-control" required>
                            <option value=""> --- <?php echo display('City') ?> ---</option>
                            <?php
                            if ($city_lists) {
                                foreach ($city_lists as $city) {
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="font-weight-500"
                                for="ship_last_name"><?php echo display('last_name') ?></label>
                            <input type="text" name="ship_last_name" id="ship_last_name"
                                placeholder="<?php echo display('last_name') ?>" class="form-control"
                                value="<?php echo set_value('ship_last_name', $this->session->userdata('ship_last_name')) ?>">
                        </div>
                        <div class="form-group">
                            <label for="ship_mobile" class="font-weight-500"><?php echo display('mobile') ?> <span
                                    class="text-danger">*</span></label>
                            <input type="text" name="ship_mobile" id="ship_mobile"
                                placeholder="<?php echo display('add_country_code') ?>" class="form-control" required
                                value="<?php echo $this->session->userdata('ship_mobile') ?>" data-toggle="tooltip"
                                data-placement="bottom" title="<?php echo display('add_country_code') ?>">
                        </div>

                        <div class="form-group">
                            <label for="ship_address_1"
                                class="font-weight-500"><?php echo display('customer_address_1') ?> <span
                                    class="text-danger">*</span></label>
                            <input type="text" name="ship_address_1" id="ship_address_1"
                                placeholder="<?php echo display('customer_address_1') ?>" class="form-control" required
                                value="<?php echo $this->session->userdata('ship_address_1') ?>">
                        </div>
                        <div class="form-group">
                            <label for="ship_address_2"
                                class="font-weight-500"><?php echo display('customer_address_2') ?> :</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ship_zip" id="ship_zip" placeholder="<?php echo display('zip') ?>"
                                class="form-control" value="<?php echo $this->session->userdata('ship_zip') ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group checkout_comment">
                        ...
                        <textarea class="form-control" id="ordre_notes" name="ordre_notes" rows="5"
                            placeholder="<?php echo display('notes_about_your_order') ?>"><?php echo $this->session->userdata('delivery_details') ?></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h5>
                        <i class="fa fa-question-circle"></i><?php echo display('use_coupon_code') ?> <a
                            ...
                            data-target="#collapseThree"><?php echo display('enter_your_coupon_here') ?></a>

                    </h5>
                    <div id="collapseThree" class="collapse">
                        <div class=" coupon">
                            <div class="form-inline">
                                <input type="text" class="form-control col-md-4" id="coupon_code" name="coupon_code"
                                    placeholder="<?php echo display('enter_your_coupon_here') ?>">
                                <a href="#" class="btn col-md-3 color4 color46 text-white"
        ...
        <div class="col-md-4 rightSidebar">
                ...
                <div class="card-body">
                    ...
                    if ($this->cart->contents()) {
                        ...
                        foreach ($this->cart->contents() as $items){
                           ...
                           /* if (!empty($items['options']['cgst'])) {
                                $cgst =  ($items['options']['cgst'] );
                                   $base_price = $items['price']/(1 + ($cgst/100));
                                     $base_price=  number_format($base_price, 2, '.', '');
                                     $cgst_tax += ($cgst * $base_price  / 100)*$items['qty'];
                                                                    
                            }
                             if (!empty($items['options']['sgst'])) {
                                $sgst =  ($items['options']['sgst'] );
                                   $base_price = $items['price']/(1 + ($sgst/100));
                                     $base_price=  number_format($base_price, 2, '.', '');
                                     $sgst_tax += ($sgst * $base_price  / 100)*$items['qty'];
                            } */

                        if (!empty($items['options']['sgst'])) {
                                $sgst =  ($items['options']['sgst'] ) * 2;
                                   $base_price = ($items['price'] * 100)/(100+$sgst);
                                    //  $base_price=  number_format($base_price, 2, '.', '');
                                     $sgst_tax = ($items['price'] * $sgst)/(100+$sgst)*$items['qty'];
                            }
						$totalSGST += $sgst_tax;
						
                            /* if (!empty($items['igst'])) {
                                $igst = ($items['igst']);
                                   $base_price = $items['price']/(1 + ($igst/100));
                                     $base_price=  number_format($base_price, 2, '.', '');
                                     $igst_tax +=( $sgst * $base_price  / 100)*$items['qty'];
                            } */
							...
							$totalPrice = $items['qty'] * $base_price;
							$totalAmount += $totalPrice + $sgst_tax + $items['igst'];
                    ...
                    <div class="row <?php echo (($counter > 1)?'mt-3 delimiter-top':'') ?>">
                        <div class="col-9">
                            <div class="media align-items-center">
                                <img alt="Image placeholder" class="mr-2"
                                    src="<?php echo  base_url().(!empty($items['options']['image'])?$items['options']['image']:'assets/img/icons/default.jpg')?>" width="64">
                                <div class="media-body">
                                    ...
                                    <div class="text-black-50 fs-14"><?php echo $items['qty'] ?> x
										...
										<?php if($user_state !== "" && $items['options']['sgst']): ?>
                        ...
                        <div class="col-3 text-dark text-right">
                            <?php $new_price = $base_price * $items['qty'];
                    ...
                    <ul class="list-unstyled font-weight-500 pb-2 border-top mt-3 pt-3">
                        <li class="d-flex justify-content-between align-items-center" id="shipCostRow"><span
                                class="mr-2 cart_ship_name"><span id="set_cart_ship_name"></span></span><span
                                class="text-right" id="set_ship_cost"></span></li>

                        
						<?php 
						/* $total = $this->cart->total();
						$tax_rate = 18; // 18% tax rate
						$sub_total = $total / (1 + ($tax_rate / 100));
						$tax_amount = $total - $sub_total;
						$igst_amount = $tax_amount / 2; */
						?>
						...
						<li class="d-flex justify-content-between align-items-center" id="sub_total"><span
                                class="mr-2"><?php echo display('sub_total') ?>:</span><span class="text-right">
                                <?php 
								$t_tax = $totalSGST / 2;

										 
                                        echo $currency . " " .number_format($sub_total,2); ?>
                                    

                            </span>
							</li>
							
							<li class="d-flex justify-content-between align-items-center tax_calculation" id="SGST">
							<?php if($user_state !== "" && $items['options']['sgst']): ?>
							<span class="label">SGST :</span>
                                    ...
                                    <span class="value">
                                        <?php
                                            ...
                                            // $total_tax = $cgst + $sgst + $igst;
                                            echo $currency . " " .number_format($t_tax,2);
						...
						<?php if($user_state != 'Punjab'): ?>
						
						<li class="d-flex justify-content-between align-items-center" id="IGST"><span
                                class="mr-2">IGST:</span><span class="text-right">
                                <?php 
                                   echo $currency . " " .number_format($totalSGST,2);
                                 ?>
                        ...
                        <li class="d-flex justify-content-between align-items-center"><span
                                class="mr-2"><?php echo display('total') ?>:</span><span class="text-right"
                                id="total_amount"><?php echo(($position1 == 0) ? $currency1 . " " . number_format($cart_total*$target_con_rate, 2, '.', ',') : number_format($cart_total*$target_con_rate, 2, '.', ',') . " " . $currency1) ?></span>
                            ...
                            <input type="hidden" name="shipping_temporary_amount" id="shipping_temporary_amount"
                                value="0">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled font-weight-500 pb-2 border-top mt-3 pt-3">
                        <li class="d-flex justify-content-between align-items-center">
                            ...
                            <input type="hidden" name="current_points"
                                value="<?php echo $current_points->current_points ?>" id="current_points">
                            <input type="hidden" name="points_per_dime" id="points_per_dime"
                                value="<?php echo $point_settings->points_per_dime; ?>">
                        </li>
                        <li class="d-flex justify-content-between align-items-center">
                            <span class="mr-2"><?php echo display('use_points') ?>:</span>
                            <span class="text-right">
                                <input class="form-control text-right" type="number" name="used_points"
                                    id="used_points">
                            </span>
                        </li>
                    </ul>
            ...
            <div class="card shadow-none mb-0">
                <div class="card-body">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="payment_method"
                                        value="<?php echo $paygateway['used_id']; ?>"
                                        <?php echo  (($this->session->userdata('payment_method') == $paygateway['used_id'])?"checked = 'checked'":""); ?>>
                                    &nbsp;
                                    <?php  if(!empty($paygateway['image'])) { ?>

                                    <img src="<?php echo base_url($paygateway['image']) ?>"
                                        alt="<?php echo ucfirst($paygateway['agent']); ?>" height="32">
                    ...
                    <button type="submit" class="btn btn-success btn-block color4 color46"
            ...
            <div class="col-md-10 col-lg-7">
                ...
                <div class="empty-cart text-center font-weight-200 py-5">
                    <svg viewBox="656 573 264 182" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <rect id="bg-line" stroke="none" fill-opacity="0.2" fill="#b5023b" fill-rule="evenodd" x="656"
                            y="624" width="206" height="38" rx="19"></rect>
                        <rect id="bg-line" stroke="none" fill-opacity="0.2" fill="#b5023b" fill-rule="evenodd" x="692"
                            y="665" width="192" height="29" rx="14.5"></rect>
                        <rect id="bg-line" stroke="none" fill-opacity="0.2" fill="#b5023b" fill-rule="evenodd" x="678"
                        ...
                        <g id="shopping-bag" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                            ...
                            <polygon id="Fill-14" fill="#b5023b"
                            ...
                            <path
                                ...
                                id="Stroke-4916" stroke="#000000" stroke-width="1" stroke-linecap="round"></path>
                            <polyline id="Stroke-4917" stroke="#000000" stroke-width="1" stroke-linecap="round"
                            ...
                            <path d="M122,87 L122,89" id="Stroke-4919" stroke="#000000" stroke-width="1"
                                stroke-linecap="round"></path>
                            <polygon id="Stroke-4922" stroke="#000000" stroke-width="1" stroke-linecap="round"
                            ...
                            <path
                                ...
                                id="Stroke-4923" stroke="#000000" stroke-width="1" stroke-linecap="round"></path>
                            ...
                            <path d="M81,45 C81,41.686 83.686,39 87,39 C90.314,39 93,41.686 93,45" id="Stroke-4925"
                                stroke="#000000" stroke-width="1" stroke-linecap="round"></path>
                            <path d="M8,0 L20,12" id="Stroke-4928" stroke="#000000" stroke-width="1"
                                stroke-linecap="round"></path>
                            <path d="M20,12 L8,29" id="Stroke-4929" stroke="#000000" stroke-width="1"
                                stroke-linecap="round"></path>
                            <path d="M20,12 L20,29" id="Stroke-4930" stroke="#000000" stroke-width="1"
                                stroke-linecap="round"></path>
                            <path d="M115,0 L103,12" id="Stroke-4931" stroke="#000000" stroke-width="1"
                                stroke-linecap="round"></path>
                            <path d="M103,12 L115,29" id="Stroke-4932" stroke="#000000" stroke-width="1"
                                stroke-linecap="round"></path>
                            <path d="M103,12 L103,29" id="Stroke-4933" stroke="#000000" stroke-width="1"
                                stroke-linecap="round"></path>
                        </g>
                        ...
                        <polygon id="plus" stroke="none" fill="#d8074a" fill-rule="evenodd"
                        ...
                        <polygon id="diamond" stroke="#C46F82" stroke-width="1" stroke-linecap="round"
...
<input type="hidden" name="coupon_message" id="coupon_message"
    value="<?php echo @$this->session->userdata('message')?>">
<input type="hidden" name="coupon_error_message" id="coupon_error_message"
    value="<?php echo @$this->session->userdata('error_message')?>">

    <script>
        $(document).ready(function(){
            var stateId = $('#state, #ship_state').children('option:selected').attr('data-id');

            fetchCities(stateId);
            $("body").on("change",'#state, #ship_state',function () {
                var stateId = $(this).children('option:selected').attr('data-id');
                fetchCities(stateId);
            });
        })
        ...
        function fetchCities(stateId){
                ...
                type: "post",
                async: true,
                url: base_url + "web/Home/retrive_cities",
                data: {
                ...
                success: function (data) {
                  //console.log(data);
                  if (data) {
                    $("#city_id,#ship_city").html(data);
                  } else {
                    $("#city_id,#ship_city").html('<p class="color_red">' + display("failed") + "</p>");
                  }
                },
                error: function () {
                  Swal({
...
$(".toggle-password").click(function() {
 ...
 /* $(document).ready(function () {
        // Change event handler for the state dropdown
        $('#state').on('change', function () {
			var userState = $('select#state option:selected').val();

            // Perform the calculation and update HTML values
            calculateAndUpdate(userState);
        });
var userState = $('select#state option:selected').val();
    ...
    function calculateAndUpdate(userState) {
        // Get the selected state value
						var isUserInYourState = userState === 'Punjab';
					
						var totalAmount = "<?= $this->cart->total(); ?>";
						if(isUserInYourState)
						{
							//console.log(totalAmount);// Example total amount
							var taxRate = 18; // 18% tax rate
							var subTotal = totalAmount / (1 + (taxRate / 100));
							var taxAmount = totalAmount - subTotal;
							var igstAmount = taxAmount / 2;
							var formattedSubTotal = subTotal.toFixed(2);
							var formattedtaxAmount = taxAmount.toFixed(2);
							$('#sub_total').html('RS '.formattedSubTotal);
							$('#IGST').addClass('d-none').removeClass('d-flex');
							
							$('.tax_calculation').removeClass('d-flex').addClass('d-block');
							$('.tax_calculation').html('<span class="mr-2">SGST/CGST (18%) :</span><span class="float-right">RS '+formattedtaxAmount+'</span>');
						...
						else
						{
							...
							var igstAmount = taxAmount / 2;
							var formattedSubTotal = subTotal.toFixed(2);
							var formattedtaxAmount = igstAmount.toFixed(2);
							$('#sub_total').html('RS '.formattedSubTotal);
							$('#IGST').addClass('d-none').removeClass('d-flex');
							$('.tax_calculation').removeClass('d-flex').addClass('d-block');
							$('.tax_calculation').html('<span class="mr-2">SGST/CGST (9%) :</span><span class="float-right">RS '+formattedtaxAmount+'</span><br/>'+'<span class="mr-2">IGST (9%):</span><span class="float-right">RS '+formattedtaxAmount+'</span>');
							
						}
    } */
	$(document).ready(function () {
    // Assuming you have a dropdown with id 'paymentMethod'
    $('input[name=payment_method]').change(function () {
        var selectedPaymentMethod = $(this).parent().text().trim();

        // Assuming you have a radio group with class 'shipping_cost'
        var $shippingCostRadios = $('.shipping_cost');

        if (selectedPaymentMethod === 'Cash On Delivery') {
            console.log(selectedPaymentMethod);

            // Find the radio button with the label 'Pick at the Center'
            var $pickAtCenterRadio = $shippingCostRadios.filter(function () {
                return $(this).closest('.radio').prev('p').find('strong').text().trim() === 'Inside the city';
            });

            // Check the found radio button
            $pickAtCenterRadio.prop('checked', true);
        } else {
            // Uncheck all radio buttons if payment method is not COD
            $shippingCostRadios.prop('checked', false);
        }
    });
});
