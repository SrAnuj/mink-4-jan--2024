...
<div class="navbar-sticky border-bottom">
    <div class="navbar navbar-expand-lg navbar-light color1">
        <div class="container">
            <a class="navbar-brand d-none d-sm-block mr-3 flex-shrink-0" href="<?php echo base_url() ?>">
                <img class="bg-transparent" width="100" src="<?php if (isset($Web_settings[0]['logo'])) {
  ...
  <div class="d-flex justify-content-between justify-content-md-end w-100">
            ...
            <a class="topbar-link d-flex align-items-center text-black" href="mailto:Manager@premierwebtech.com" >
                <i data-feather="user" class="mr-2 text-black ti-themify-favicon"></i><?php echo 'Support' ?></a> &nbsp;
                 <a class="topbar-link d-flex align-items-center text-black" href="#" data-toggle="modal" data-target="#trackingModal">
            ...
            <?php } else { ?>
            <a class="topbar-link d-flex align-items-center text-black" href="#" data-toggle="modal" data-target="#loginModal">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav mega-nav departments-nav pr-lg-2 mr-lg-2">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle pl-0 text-black" href="#" data-toggle="dropdown"> <i data-feather="grid"
                        ...
                        <ul class="dropdown-menu  	">
                            ...
                            ?>
                            <li class="dropdown mega-dropdown text-black">
                                    ...
                                    <div class="d-flex flex-wrap flex-md-nowrap position-relative px-lg-2">
                                        ...
                                        <div class="mega-dropdown-column py-4 px-lg-3">
                                            ...
                                            <div class="widget widget-links">
                                                <h6 class="mb-3"><a class="text-dark"
                ...
                <ul class="navbar-nav">
                    <li class="nav-item  <?php echo (($this->uri->segment(1) == '') ? 'active' : '') ?>">
                        <a class="nav-link active bg-success text-white " style="border-radius: 0 5px 5px 0px"  href="<?php echo base_url(); ?>"><?php echo display('home') ?> <span
                                 class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('all_products'); ?>">Our Products</a>
                    </li>
                    <!--<li class="nav-item <?php echo (($this->uri->segment(1) == '') ? '' : '') ?>">-->
                    <!--    <a class="nav-link" href="<?php echo base_url('about_us'); ?>"><?php echo display('about_us') ?> <span-->
                    <!--            class="sr-only">(current)</span></a>-->
                    <!--</li>-->
                    ...
                    <!--</li> -->
                    <!--<li class="nav-item <?php echo (($this->uri->segment(1) == '') ? '' : '') ?>">-->
                    <!--    <a class="nav-link" href="<?php echo base_url(); ?>">Testemonials</a>-->
                    <!--</li>-->
                    <!-- <li class="nav-item <?php echo (($this->uri->segment(1) == '') ? '' : '') ?>">-->
                    <!--    <a class="nav-link" href="<?php echo base_url('contact_us'); ?>"><?php echo display('contact_us') ?> <span-->
                    <!--            class="sr-only">(current)</span></a>-->
                    <!--</li>-->
                    <?php
