        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="product-summary-content pl-md-4">
                    <div class="product-price-summary">
                            ...
                            <?php 
                             ...
                             if($is_perishable == 1){
                                ...
                                This is a perishable item, hence 
                                its delivery will be under city only.</div>";
                             }
                             ?>
                    ...
                    <div class="product-price-summary">
                        <?php 
                            $target_con_rate = 1;   // no data tracable from result, so defined manually
                            $currency1 = $currency; // no data tracable from result, so defined manually
                            if ($onsale) { ?>
                    ...
                    <a href="javascript:void(0)"
                        ...
                        <i data-feather="heart" class="far fa-heart navbar-tool-icon"></i>
                    </a>
                        ...
                        <div class="tag-as">
                            ...
                            <?php
                                ...
                                foreach ($tags as $tagval) {
                                    echo (($i > 1) ? ',' : '');
                                    $i++ ?>
                            <a href="<?php echo base_url('tag/TAG_' .remove_space($tagval)); ?>" class="text-black-50"><?php echo html_escape($tagval); ?></a>
                            <?php } ?>
                        </div>
                        <?php } ?>
                        <div>
                            <!--<iframe src="https://www.youtube.com/watch?v=97zGmkdhSNU" width="100%" height="100%" ></iframe>-->
							...
							if ($videoId) {
								...
								$embedCode = '<iframe width="555" height="312" src="https://www.youtube.com/embed/' . $videoId . '" frameborder="0" allowfullscreen></iframe>';
								
								echo $embedCode;
							} else {
								echo 'Invalid YouTube video URL or ID';
							}
				...
				if ($user_type == 6) {
					if ($all_products) {
						foreach ($all_products as $key => $product) {
							$all_products[$key]->price = $product->retail_price;
						}
					}
				}
				if ($user_type == 7) {
					if ($all_products) {
						foreach ($all_products as $key => $product) {
							$best_sales_category[$key]->price = $product->wholesale_price;
						}
					}
				}
