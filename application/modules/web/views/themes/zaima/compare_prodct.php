                    ...
                    if ($this->session->userdata('comparison_ids')) {
						...
						if ($user_type == 6) {
							if ($comparison_products) {
								foreach ($comparison_products as $key => $retail_product) {
									
									$comparison_products[$key]['price'] = $retail_product['retail_price'];
								}
							}
						}
						//7 is wholesaler 
						if ($user_type == 7) {
							if ($comparison_products) {
								foreach ($comparison_products as $key => $whole_product) {
									$comparison_products[$key]['price'] = $whole_product['wholesale_price'];
								}
							}
						}
