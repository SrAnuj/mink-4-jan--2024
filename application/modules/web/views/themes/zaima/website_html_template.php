...
<head>
    ...
    <meta property="og:description"
        content="<?php echo (!empty($product_details) ? character_limiter(strip_tags(htmlspecialchars_decode($product_details)), 200) : ''); ?>">
    ...
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i"
        rel="stylesheet">
    <link
        href="https://fonts.googleapis.com/css2?family=Kaushan+Script&family=Raleway:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
        rel="stylesheet">
    ...
    <link href="<?php echo THEME_URL . $theme . '/assets/plugins/pe-icon-7-stroke/css/pe-icon-7-stroke.css'; ?>"
        rel="stylesheet">
    <link href="<?php echo THEME_URL . $theme . '/assets/plugins/themify-icons/themify-icons.css'; ?>" rel="stylesheet">
    <link href="<?php echo THEME_URL . $theme . '/assets/plugins/OwlCarousel2/css/owl.carousel.min.css'; ?>"
        rel="stylesheet">
    <link href="<?php echo THEME_URL . $theme . '/assets/plugins/OwlCarousel2/css/owl.theme.default.min.css'; ?>"
        rel="stylesheet">
    ...
    <link href="<?php echo THEME_URL . $theme . '/assets/plugins/Magnific-Popup/magnific-popup.css'; ?>"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo THEME_URL . $theme . '/assets/plugins/PhotoSwipe/dist/photoswipe.css'; ?>" rel="stylesheet">
    <link href="<?php echo THEME_URL . $theme . '/assets/plugins/PhotoSwipe/dist/default-skin/default-skin.css'; ?>"
        rel="stylesheet">
    <link href="<?php echo THEME_URL . $theme . '/assets/plugins/raty/lib/jquery.raty.css'; ?>" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo THEME_URL . $theme . '/assets/plugins/ion.rangeSlider/css/ion.rangeSlider.min.css'; ?>"
        rel="stylesheet">
    <link rel="stylesheet"
        href="<?php echo THEME_URL . $theme . '/assets/plugins/jquery-ui/smoothness/jquery-ui.min.css'; ?>">
...
<body>
                ...
                <div class="modal-body">
                    ...
                    <div class="accordion" id="accordionExample">
						...
						<div class="alert alert-danger mb-3">
									...
									Please login with your phone number and password. Otherwise you will not be able to login.
									</p>
                                </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="customer_mobile" id="user_login_email"
                                    placeholder="<?php echo display('mobile') ?>" required>
                            </div>
                            <div class="form-group">
									<div class="input-group" id="show_hide_password">
                                        <input type="password" class="form-control" name="password" id="user_login_password" placeholder="<?php echo display('password') ?>">
										 <div class="input-group-prepend">
											<a class="btn btn-primary text-white toggle-password" type="button">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label"
                                        for="remember"><?php echo display('remember_me') ?></label>
                                </div>
                                <a href="<?php echo base_url('forget_password_form') ?>"
                                    class="forgot d-block text-left"><?php echo display('forget_password') ?></a>
                            </div>
                            <button type="submit"
                                class="btn btn-primary btn-block"><?php echo display('login') ?></button>
                            <?php echo form_close(); ?>
                        </div>
                        <div id="collapseTwo" class="collapse" data-parent="#accordionExample">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="first_name" id="cus_first_name"
                                    placeholder="<?php echo display('first_name') ?>" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="last_name" id="cus_last_name"
                            ...
                            <div class="form-group">
                                <input type="text" id="birth_day" name="birth_day" class="form-control datepicker"
                                    placeholder="DOB">
                                <p id="birth_day"></p>
                            </div>
                            <div class="form-group">
                                <input type="text" id="mobile" name="phone" class="form-control"
                                    placeholder="<?php echo display('mobile'); ?>" required>
                                <p id="mobile_warning"></p>

                            </div>
                            <div class="form-group">
                                <input type="password" id="user_pw" class="form-control" name="password"
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12 form-group">
                            <a class="btn btn-google btn-sm btn-block  search text-white"
                                href="<?php echo base_url('googlelogin/googlelogin/login') ?>"><i
                                    class="fab fa-google mr-1"></i> <?php echo display('google_login') ?></a>
                        </div>
                        <?php } ?>
                        <?php if ((check_module_status('facebooklogin') == 1)) { ?>
                        <div class="col-md-12 form-group">
                            <a class="btn btn-facebook btn-sm btn-block  search text-white"
                                href="<?php echo base_url('facebooklogin/facebooklogin/index/1') ?>"><i
                                    class="fab fa-facebook mr-1"></i><?php echo display('facebook_login') ?></a>
                        </div>
                        <?php } ?>
                        <?php if ((check_module_status('linkedinlogin') == 1)) { ?>
                        <div class="col-md-12 form-group">
                            <a class="btn btn-linkedin btn-sm btn-block  search text-white"
                                href="<?php echo base_url('linkedinlogin/linkedinlogin/login/1') ?>"><i
                                    class="fab fa-linkedin mr-1"></i><?php echo display('linkedin_login') ?></a>
                        </div>
                        <?php } ?>
                    </div>
                </div>
    ...
    <script
        src="<?php echo THEME_URL . $theme . '/assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.min.js'; ?>">
    </script>
