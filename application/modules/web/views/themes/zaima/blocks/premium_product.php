...
<div class="feature-product py-4">
	...
	<h3 class="category-headding ">Step By Lifestyle</h3>
	</div>
		<div class="row form-group">
...
//d($all_products);die;
 ...
 <?php $prodlink =  base_url('/product/' . remove_space($product->product_name) . '/' . $product->product_id) ?>
            ...
            <div class="loadingdata" id="remove-row">
            <button type="button" class="btn btn-outline-success float-end mt-4" id="load_more" data-id="<?php echo $product->id; ?>">View All Premium Product <i
