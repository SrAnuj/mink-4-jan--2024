...
<aside class="main-sidebar">
	...
	<div class="sidebar">
	    ...
	    <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if ($this->uri->segment('2') == ("invoice")) { echo "active";}else{ echo " ";}?>">
                <a href="#">
                    <i class="ti-layout-accordion-list"></i><span><?php echo 'Subscription' ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url('customer/subscription')?>"><?php echo 'Subscription' ?></a></li>
                                        <li><a href="<?php echo base_url('customer/subscription/manage_subscription')?>"><?php echo 'Manage Subscription' ?></a></li>
