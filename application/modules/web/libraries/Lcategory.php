...
class Lcategory
{
    ...
    //Category product
    public function category_product($cat_id, $links, $per_page, $page, $price_range = null, $size = null, $brand = null, $rate = null,$filter_item=null,$tag = null)
    {
        ...
        $max_value = 0;
        $min_value = 0;
        $category_product = $CI->Categories->category_product($cat_id, $per_page, $page, $price_range, $size, $brand, $rate,$filter_item,$tag);
