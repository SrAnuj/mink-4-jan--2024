...
class Lorder {
		...
		public function subscription_add_form()
	{
		...
		$subscriptionForm = $CI->parser->parse('web/customer/subscription/add_subscription_form',$data,true);
...
// 	subscription data
	...
	public function subscription_list()
	{
		...
		$subscription_list = $CI->Orders->subscription_list();
...
// die();
		...
		$orderList = $CI->parser->parse('web/customer/subscription/subscription',$data,true);
		return $orderList;
	}
