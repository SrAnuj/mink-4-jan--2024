...
class User_auth {
	...
	public function login($email,$password)
	{
        ...
        if ($result)
		{
			...
			//print_r($customer_activities);die;
			...
			$user_data = array(
				...
				'customer_id' 	=> $result[0]['customer_id'],
				'customer_name' => (!empty($result[0]['customer_name'])) ? $result[0]['customer_name'] : $result[0]['first_name']." ".$result[0]['last_name'],
	...
	{ 	
        ...
        $CI->db->where(array('customer_mobile'=>$email,'password'=>$password));
