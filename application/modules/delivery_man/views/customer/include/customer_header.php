...
<header class="main-header">
    <a href="<?php echo base_url('delivery_dashboard')?>" class="logo">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php echo base_url('delivery/delivery_dashboard/edit_profile')?>"><i class="pe-7s-users"></i><?php echo display('customer_profile') ?></a></li>
                        ...
                        <li><a href="<?php echo base_url('delivery_logout')?>"><i class="pe-7s-key"></i><?php echo display('logout') ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
	...
	<div class="sidebar">
	    ...
	    <ul class="sidebar-menu">
	        <li class="<?php if ($this->uri->segment('1') == ("")) { echo "active";}else{ echo " ";}?>">
	            <a href="<?php echo base_url('delivery_man/customer/Delivery_dashboard')?>"><i class="ti-dashboard"></i> <span><?php echo display('dashboard') ?></span>
             ...
             <li class="treeview <?php if ($this->uri->segment('2') == ("invoice")) { echo "active";}else{ echo " ";}?>">
              <a href="#">
                ...
                <ul class="treeview-menu">
                    <li>  <a
                                href="<?php echo base_url('delivery_man/customer/Delivery_auth/manage_assigned_delivery') ?>"><?php echo display('assign_delivery') ?></a></li>

                    <!--'web/customer/Corder/manage_subscription'-->
                </ul>
            </li>
            <!-- Invoice menu end -->
            <!-- Order menu start -->
