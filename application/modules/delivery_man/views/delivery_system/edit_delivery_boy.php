...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                    <a href="<?php echo base_url('delivery_man/customer/Delivery_auth/manage_assigned_delivery') ?>"
                        class="btn btn-success m-b-5 m-r-2"><i
                            class="ti-align-justify"></i><?php echo display('manage_assign_delivery') ?></a>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <?php echo form_open_multipart('delivery_man/customer/Delivery_dashboard/edit_profile/' . $delivery_boy_info['id']); ?>
