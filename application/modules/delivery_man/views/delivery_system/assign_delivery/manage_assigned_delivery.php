								...
								?>
									<tr>
										...
										<?php
											...
											$this->db->join('order b','a.order_no = b.order','inner');
										...
										<td class="text-center">
											<?php if ($assigned_delivery['status'] == 'Active' || $assigned_delivery['status'] == 'Completed') { ?>
											<span class="label label-success"><?php echo $assigned_delivery['status'] ?></span>
											<?php }else{ ?> 
											<span class="label label-danger"><?php echo $assigned_delivery['status'] ?></span>
											<?php } ?>
										</td>
										<td>
											<center>
												<a href="<?php echo base_url().'delivery_man/customer/Delivery_dashboard/edit_assigned_delivery/'.$assigned_delivery['delivery_id']; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>">
													<i class="fa fa-pencil" aria-hidden="true"></i>
												</a>
												<a href="<?php echo base_url('delivery_man/customer/Delivery_dashboard/assigned_delivery_delete/'.$assigned_delivery['delivery_id'])?>" class="delete_store_product btn btn-danger btn-sm" onclick="return confirm('<?php echo display('are_you_sure_want_to_delete')?>');" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo display('delete') ?> ">
