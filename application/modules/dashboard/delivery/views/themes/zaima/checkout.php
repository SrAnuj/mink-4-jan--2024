    ...
    <div class="row">
        <div class="col-md-8 mainContent">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="font-weight-500"
                            for="customer_email"><?php echo display('customer_email') ?></label>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="font-weight-500" for="city"><?php echo display('city') ?><span
                                class="text-danger">*</span></label>
                        <input type="text" name="city" id="city" placeholder="<?php echo display('city') ?>"
                            class="form-control" required
                            value="<?php echo set_value('city', $this->session->userdata('city')) ?>">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="font-weight-500" for="ac_pass"><?php echo display('password') ?><span
                                    class="text-danger">*</span></label>
                            <input type="text" name="ac_pass" id="ac_pass"
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled font-weight-500 pb-2 border-top mt-3 pt-3">
                        ...
                        <li class="d-flex justify-content-between align-items-center"><span
                                class="mr-2"><?php echo display('total_tax') ?>:</span><span class="text-right">
                                <?php 
