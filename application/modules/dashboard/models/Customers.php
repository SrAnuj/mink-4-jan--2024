...
class Customers extends CI_Model {
	...
	{
		$this->db->select('customer_information.*, delivery_zone.delivery_zone');
		$this->db->from('customer_information');
		$this->db->join('delivery_zone', 'customer_information.customer_zone = delivery_zone.id', 'left'); 
		$this->db->order_by('customer_information.customer_name', 'asc');
		$query = $this->db->get();
	...
	public function customer_personal_data($customer_id)
	{
		$this->db->select('customer_information.*, delivery_zone.delivery_zone');
		$this->db->from('customer_information');
		$this->db->join('delivery_zone', 'customer_information.customer_zone = delivery_zone.id', 'left'); // Adjust the join condition as needed
		$this->db->where('customer_information.customer_id',$customer_id); // Adjust the join condition as needed
		$this->db->order_by('customer_information.customer_name', 'asc');
		$query = $this->db->get();
