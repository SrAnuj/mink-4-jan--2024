...
var csrf_test_name=  $("#CSRF_TOKEN").val();
    ...
    $(document).on('change', '.variant_id, .color_variant', function() {
		var id = $(this).data('id');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data) {
					...
					//console.log(new_data.stock);
					
						var dynamicValue = new_data.stock;
						$('#avl_qntt_' + sl).val(dynamicValue);

						
						
						var dynamicID = 'avl_stock_' + id;
						if ($('#' + dynamicID).length > 0) {
							$('#' + dynamicID).val(new_data.stock); // Use the 1 as the key
							console.log(counter);
