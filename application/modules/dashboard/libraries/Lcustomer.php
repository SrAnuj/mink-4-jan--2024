...
class Lcustomer {
	...
	public function customer_edit_data($customer_id)
	{
		...
		$data=array(
			...
			'customer_short_address'=>$customer_detail[0]['customer_short_address'],
			'customer_address_1'=>$customer_detail[0]['customer_address_1'],
			...
			'zone_id' 		=>$customer_detail[0]['customer_zone'],
			'zone_list' => $zone_list
			);
	...
	public function customer_ledger_report($customer_id,$from_date=null,$to_date=null)
	{
		...
		$data=array(
			...
			'customer_address' 	=>@$customer_detail[0]['customer_short_address'],
			'previous_balance' 	=>@$customer_detail[0]['previous_balance'],
			'customer_address_1'=>@$customer_detail[0]['customer_short_address'],
			'customer_mobile' 	=>@$customer_detail[0]['customer_mobile'],
			'customer_email' 	=>@$customer_detail[0]['customer_email'],
			'vat_no' 	        =>@$customer_detail[0]['vat_no'],
			'cr_no' 	        =>@$customer_detail[0]['cr_no'],
			...
			'total_balance'		=>number_format(-$summary[1][0]['total_debit']+$summary[0][0]['total_credit']+$customer_detail[0]['previous_balance'], 2, '.', ','),
	...
	public function customerledger_data($customer_id)
	{
		...
		$company_info 	= $CI->Customers->retrieve_company();
		$currency_details = $CI->Soft_settings->retrieve_currency_info();
		//echo $customer_detail[0]['delivery_zone'];die;
		$data=array(
			'title'				=> display('customer_ledger'),
			'customer_id' 		=> $customer_detail[0]['customer_id'],
			'customer_name' 	=> $customer_detail[0]['customer_name'],
			...
			'customer_mobile' 	=> $customer_detail[0]['customer_mobile'],
			'customer_email' 	=> $customer_detail[0]['customer_email'],
			'delivery_zone' 	=> $customer_detail[0]['delivery_zone'],
			'previous_balance' 	=> $customer_detail[0]['previous_balance'],
			'city' 				=> $customer_detail[0]['city'],
			'state' 			=> $customer_detail[0]['state'],
