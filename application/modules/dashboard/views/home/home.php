...
<div class="content-wrapper color3">
	...
	<?php
        ...
        ?>
	<?php $user_type = $this->session->userdata(); if($user_type['user_type'] == 1):?>
	<div class="row form-group">
	<h2>Monthly (30 Days) Target Assigned Report</h2>
            <div class="col-md-12">
				...
				<?php foreach($all_stores as $store_target):?>
                    <tr>
                        <td><?php echo $store_target->store_name; ?></td>
                        <td><?php echo $store_target->total_completed_targets; ?></td>
                        <td><?php echo $store_target->total_pending_targets; ?></td>
                        <td><?php echo $store_target->total_targets; ?></td>
                        <td><?php echo $store_target->target_percentage; ?></td>
       ...
       <div class="row form-group">
	    <h2>Daily Target Assigned Report</h2>
            <div class="col-md-12">
                <div class="card-body bg-white">
                    <div class="table-responsive">
                     <table id="data_table" class="table">
                ...
                <tbody>
				<?php if(count($all_store_target) > 0):?>
				<?php foreach($all_store_target as $store_target):?>
                    <tr>
                        <td><?php echo $store_target->store_name; ?></td>
                        <td><?php echo $store_target->occupied_targets; ?></td>
                        <td><?php echo $store_target->target_pending; ?></td>
                        <td><?php echo $store_target->daily_target_value; ?></td>
                        <td><?php echo $store_target->target_achieved_percentage; ?></td>
						<td><?php echo $store_target->target_date ? date('d-m-Y',strtotime($store_target->target_date)) : '' ?></td>
                    </tr>
        ...
        <div class="row">
			...
			<?php if($user_type['user_type'] == 6 || $user_type['user_type'] == 7): ?>
                <a href="<?php echo base_url('dashboard/Corder/manage_order') ?>">
                    <div class="small-box dashbox dashbox-blue bg-white">
                        <div class="inner">
							
                            <h3><span class=""><?php echo html_escape($user_order_count); ?></span></h3>
                            <p><?php echo display('total_order') ?></p>
				...
				<a href="<?php echo base_url('dashboard/Ccustomer/manage_customer') ?>">
                    <div class="small-box dashbox dashbox-blue bg-white">
                        <div class="inner">
							 ...
							 <h3><span class=""><?php echo html_escape($total_customer); ?></span></h3>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                ...
                <div class="small-box dashbox dashbox-info  bg-white">
                    <div class="inner">
                        <h3><span class=""><?php echo html_escape($total_product); ?></span></h3>
            ...
            if($this->session->userdata('sales_target') > 0)
            {?>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <a href="<?php echo base_url('dashboard/Cproduct/manage_product') ?>">
                <div class="small-box dashbox dashbox-info  bg-white">
                    <div class="inner">
                        <h3><span class=""><?php echo html_escape($this->session->userdata('sales_target')); ?></span></h3>
                        <p><?php echo 'Sales Target' ?></p>
                    </div>
                    <div class="icon">
                        <img src="<?php echo base_url('my-assets/image/dashboard/products.png') ?>" class="img img-responsive" >
                    </div>
...
<?php if ($this->session->userdata('user_type') == '1') { ?>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                ...
                <div class="small-box dashbox dashbox-red bg-white">
                    <div class="inner">
                        <h3><span class=""><?php echo html_escape($total_suppliers); ?></span></h3>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                ...
                <div class="small-box dashbox dashbox-green bg-white">
                    <div class="inner">
                        <h3><span class=""><?php echo html_escape($total_sales); ?></span></h3>
        ...
        <?php if ($this->session->userdata('user_type') == '4') { ?>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                ...
                <div class="small-box dashbox dashbox-green bg-white">
                    <div class="inner">
                        <h3><span class=""><?php echo html_escape($total_store_invoice); ?></span></h3>
                        <p><?php echo display('total_invoice') ?></p>
                    </div>
                    <div class="icon">
                        <img src="<?php echo base_url('my-assets/image/dashboard/invoice.png') ?>" class="img img-responsive">
			...
			<div class="table-responsive">
             <table id="targetTable" class="table table-stripped table-hover">
						<thead>
							<tr>
								<th>Store Name </th>
								<th>Total Target</th>
					...
					<tbody>
						<?php foreach ($get_all_target as $row): ?>
						<tr>
							
							<td><?php echo $row['store_name']; ?></td>
							<td><?php echo $row['total_targets']; ?></td>
							<td><?php echo $row['total_completed_targets']; ?></td>
							<td><?php echo $row['total_pending_targets']; ?></td>
							<td><?php echo $row['target_percentage']; ?></td>
