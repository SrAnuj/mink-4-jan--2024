...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('import_purchase_excel') ?></h1>
            <small><?php echo display('import_purchase_excel') ?></small>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url('')?>"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="<?php echo base_url('dashboard/Cproduct')?>"><?php echo display('product') ?></a></li>
                <li class="active"><?php echo display('import_purchase_excel') ?></li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('excel_file_informaion')?></h4>
                        </div>
                    </div>
                    <div class="panel-body">
                        <a href="<?php echo base_url('assets/data/excel/purchase_excel_sample.xlsx') ?>" class="btn btn-primary pull-right" download="purchase_excel_sample.xlsx"><i class="fa fa-download"></i><?php echo display('download_sample_file')?></a>
                            <span class="text-warning">The first line in downloaded excel file should remain as it is. Please do not change the order of columns.</span><br>The correct column order is <span class="text-info">(supplier_id, category_id, product_name, price, supplier_price,retail_price,wholesale_price, unit,moq, product_model, product_details, image_thumb, brand_id, variants, variant_price, type, best_sale, onsale, onsale_price, invoice_details, image_large_details,review, description, tag, specification, status, languages, trans_names, trans_details, trans_description and trans_specification separated by vertical bar)</span> &amp; you must follow this.<br><p>The images should be uploaded in <strong>For thumb image: <?php echo base_url('my-assets/image/product/thumb')?></strong> And for details image: <strong><?php echo base_url('my-assets/image/product')?></strong> folder.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('import_purchase_excel') ?></h4>
                        </div>
                    </div>
                    <?php echo form_open_multipart('dashboard/Cpurchase/purchase_excel_insert',array('class' => 'form-vertical', 'id' => 'validate','name' => 'insert_product'))?>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="upload_excel_file" class="col-sm-4 col-form-label"><?php echo display('upload_excel_file') ?><i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                                        <input class="form-control" name="upload_excel_file" type="file" id="upload_excel_file" placeholder="<?php echo display('upload_excel_file') ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
