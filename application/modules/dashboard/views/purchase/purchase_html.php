                ...
                <div class="panel panel-bd">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo html_escape(!empty($purchase['sgst']) ? $purchase['sgst'] : 0) . ' %'; ?>
                                            </td>
                                            <td><?php echo html_escape(!empty($purchase['cgst']) ? $purchase['sgst'] : 0) . ' %'; ?>
                                            </td>
                                              <td><?php echo html_escape(!empty($purchase['igst']) ? $purchase['igst'] : 0) . ' %'; ?>
                                            </td>
                                            <td>
                                                <?php
                                        ...
                                        <?php
                                                ...
                                                $cgst=$purchase['cgst']*$purchase['quantity'] * $purchase['rate']/100;
                                                 $sgst=$purchase['sgst']*$purchase['quantity'] * $purchase['rate']/100;
                                                $igst=$purchase['igst']*$purchase['quantity'] * $purchase['rate']/100;

                                                $total_vat += $igst + $sgst + $cgst;
                                                ?>
                                        <?php
                                            }
                                        }
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="width_30p ft_right">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <th class="grand_total">Total with Tax:</th>
                                    ...
                                    <table class="table">
                                        <thead>
                                            ...
                                            <th class="text-right" style="width: 33%">
											 ...
											 <th class="text-right" style="width: 33%">
											    <?php $user_name = $this->session->userdata('user_name'); echo $user_name; ?><br/>
                                                <strong style="border-top:1px solid #ddd">Invoice Generator</strong>
                                            </th>
                                        </thead>
                                    </table>
                                </div>
                    ...
                    <div class="panel-footer text-left">
                        ...
                        <a class="btn btn-danger"
                            href="<?php echo base_url('dashboard/Cpurchase/manage_purchase'); ?>"><?php echo display('back') ?></a>
