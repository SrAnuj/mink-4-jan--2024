...
<div class="content-wrapper">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="product_name"
                                        class="col-sm-3 col-form-label"><?php echo display('invoice_no') ?> <i
                                            class="text-danger">*</i></label>
                                    <div class="col-sm-9">
                        ...
                        <div class="table-responsive mt_10">
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?php echo display('discount') . ' (%)' ?> </th>
                                         <th class="text-center"><?php echo 'product Cgst' ?> </th>
                                       <th class="text-center"><?php echo 'product Igst' ?> </th>
                                        <th class="text-center"><?php echo 'product Sgst' ?> </th>`
                                ...
                                <tbody id="addPurchaseItem">
                                    <?php
                                    if ($purchase_info) {
                                        // var_dump($purchase_info[][cgst]);
                                        // die();
                                        foreach ($purchase_info as $purchase) {
                                        //       var_dump($purchase['cgst']);
                                        // die();
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            <input type="number" name="cgst[]" id="cgst_<?php echo $purchase['sl'] ?>"    onkeyup="calculate_add_purchase(<?php echo $purchase['sl'] ?>);"
                                                onchange="calculate_add_purchase(<?php echo $purchase['sl'] ?>);"   value="<?php echo $purchase['cgst'] ?>"
                                                class="form-control text-right cgst " placeholder="0.00" min="0" readonly/>
                                        </td>
                                          <td>
                                            <input type="text" name="igst[]"  value="<?php echo $purchase['igst'] ?>" id="igst_<?php echo $purchase['sl'] ?>"    onkeyup="calculate_add_purchase(<?php echo $purchase['sl'] ?>);"
                                                onchange="calculate_add_purchase(<?php echo $purchase['sl'] ?>);"
   ...
   <!--                                     </td>-->
                                        ...
                                        <td>
                                            <input type="number" name="vat[]" value="<?php echo $purchase['sgst'] ?>"
                                                id="item_vat_<?php echo $purchase['sl'] ?>" onkeyup="calculate_add_purchase(<?php echo $purchase['sl'] ?>);"
                                                onchange="calculate_add_purchase(<?php echo $purchase['sl'] ?>);"
                                                            ...
                                                            <select class="form-control dont-select-me"
                                                                ...
                                                                <option
                                                                    ...
                                                                    value="cash"><?php echo display('cash') ?></option>
                                                                       <option value="card"><?php echo 'card' ?>
                                                                </option>
