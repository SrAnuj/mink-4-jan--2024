                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive mt_10">
                            <table class="table table-bordered table-hover nowrap" id="purchaseTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?php echo 'Quantity' ?> <i
                                                class="text-danger">*</i></th>
                                        <th class="text-center"><?php echo display('rate') ?> <i
                                                class="text-danger">*</i></th>
                                        <th class="text-center"><?php echo display('discount') . ' (%)' ?> </th>
										<th class="text-center Product_sgst" id="Product_sgst"><?php echo 'Product Sgst' ?> </th>
                                        <th class="text-center Product_cgst" id=""><?php echo 'Product Cgst' ?> </th>
                                       <th class="text-center Product_Igst" id=""><?php echo 'Product Igst' ?> </th>
                                        
                                          <!--<th class="text-center"><?php echo 'Total tax' ?> </th>-->
                                ...
                                <tbody id="addPurchaseItem">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="product_rate[1]" id="price_item_1"
                                                class="price_item1 text-right form-control" placeholder="0.00"
                                                onkeyup="calculate_add_purchase('1')"
                                                onchange="calculate_add_purchase('1')" min="0"  readonly/>
                                        </td>
                                        <!-- Discount -->
                                        <td>
										...
										<td class="Product_sgst">
                                            <input type="text" name="vat[1]" id="item_vat_1"
                                                class="form-control text-right item_vat" placeholder="0.00" min="0"
                                                readonly />
                                        </td>
                                         <td class="Product_cgst">
                                            <input type="text" name="cgst[1]" id="cgst_1"  onkeyup="calculate_add_purchase(1);"
                                                onchange="calculate_add_purchase(1);"
                                                class="form-control text-right cgst" placeholder="0.00" min="0" readonly/>
                                        </td>
                                          <td class="Product_Igst">
                                            <input type="text" name="igst[1]" id="igst_1"  onkeyup="calculate_add_purchase(1);"
                                                onchange="calculate_add_purchase(1);"
                                                class="form-control text-right igst" placeholder="0.00" min="0" readonly/>
                                        </td>
                                        
                                          <!--<td class="text-right">-->
                                            <input class="total_tax text-right form-control" type="hidden"
                                                name="total_tax[1]" id="total_tax_1" placeholder="0.00"
                                                readonly="readonly" />
                                        <!--</td>-->
                                        <td class="text-right">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <b><?php echo 'Total Cgst' ?>:</b>
                                        </td>
                                        <td>
                                            <input type="text" id="total_purchase_vat" class="text-right form-control "
                                                        ...
                                                        <td>
                                                            <select class="form-control dont-select-me"
                                                                ...
                                                                <option value="cash"><?php echo display('cash') ?>
                                                                 ...
                                                                 <option value="cash free"><?php echo 'cash free' ?>
                                                                </option>
                                                                <option value="Paytm"><?php echo 'Paytm' ?>
                                                                </option>
                                                                 <option value="Wallet"><?php echo 'Wallet/Prepaid' ?>
                                                                </option>
                                                                <?php
                                                                if ($bank_list) {
