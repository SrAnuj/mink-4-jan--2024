        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                    ...
                    <a href="<?php echo base_url('dashboard/Cpurchase')?>" class="btn btn-success m-b-5 m-r-2"><i
                            class="ti-plus"> </i> <?php echo display('add_purchase')?></a>
                    <?php } ?>
                </div>
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <a href="<?php echo base_url().'dashboard/Cpurchase_return/purchase_return_form/'.$purchase['purchase_id']; ?>"
                                                    class="btn btn-warning btn-sm" data-toggle="tooltip"
                                                    data-placement="left"
                                                    title="<?php echo display('return_purchase') ?>"><i
                                                ...
                                                <a href="<?php echo base_url('dashboard/Cpurchase/purchase_delete/'.$purchase['purchase_id'])?>"
