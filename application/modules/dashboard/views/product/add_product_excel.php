...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('import_product_excel') ?></h1>
            <small><?php echo display('import_product_excel') ?></small>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url('')?>"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="<?php echo base_url('dashboard/Cproduct')?>"><?php echo display('product') ?></a></li>
                <li class="active"><?php echo display('import_product_excel') ?></li>
            </ol>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <a href="<?php echo base_url('assets/data/excel/product_excel_sample.xlsx') ?>" class="btn btn-primary pull-right" download="product_excel_sample.xlsx"><i class="fa fa-download"></i><?php echo display('download_sample_file')?></a>
