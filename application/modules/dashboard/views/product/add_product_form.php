                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" name="product_name" autofocus
                                ...
                                <div class="row text-center">
                                    <div class="col-sm-12">
                                      ...
                                      <label class="switch switch-left-right">
                                        <input class="switch-input" type="checkbox"  id="toggleProductAttr" name="is_perishable">
                                        <span class="switch-label" data-on="perishable" data-off="None Perishable"></span> <span class="switch-handle"></span> </label>
                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="description" class="form-control summernote"
                                                        ...
                                                        id="description" required row="3"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="tab3">
                                    ...
                                    <div class="form-group row">
                                        <label for="retail_price"
                                            class="col-sm-4 col-form-label">Retaile price
                                            <span class="color-red">*</span></label>
                                        <div class="col-sm-4">
                                            <input type="number" tabindex="4" class="form-control text-right"
                                                name="retail_price" value="<?php echo set_value('retailer_price') ?>"
                                    ...
                                    <div class="form-group row">
                                        <label for="wholesale_price"
                                            class="col-sm-4 col-form-label">Wholesale price
                                            <span class="color-red">*</span></label>
                                        <div class="col-sm-4">
                                            <input type="number" tabindex="4" class="form-control text-right"
                                                name="wholesale_price" value="<?php echo set_value('wholesale_price') ?>"
                                    ...
                                    <div class="form-group row igst_tax none">
                                        <label for="onsale_price"
                                            class="col-sm-4 col-form-label"><?php echo 'IGST Tax'; ?> <i
                                                class="text-danger">*</i></label>
                                        <div class="col-md-4">
                                            <!--<input class="form-control text-right" name="igst_tax" type="number"-->
                                            <!--    required="" placeholder="<?php echo 'IGST Tax';?>" min="0"-->
                                            <!--    id="igst">-->
                                                
                                                   <select class="select2 width_100p form-control" name="igst_tax" id="igst">
                                      ...
                                      <div class="form-group row">
                                        <label for="model"
                                            class="col-sm-4 col-form-label"><?php echo 'H.S.N Code'; ?> <span
                                                class="color-red">*</span></label>
                                        <div class="col-sm-4">
                                            <input type="text" tabindex="5" class="form-control" name="hsn"
                                                placeholder="<?php echo 'H.S.N Code';?>"
                                                value="<?php echo set_value('model') ?>" required id="model" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
...
<script>
 ...
 var dynamicValues = <?= json_encode($cities) ?>;
...
var attr_count = 0;
    ...
    $('#commentForm').submit(function (event) {
      // Check if the perishable checkbox is checked
      if ($('#toggleProductAttr').is(':checked')) {
        if ($('.get_cities option:selected').length === 0) {
          alert('Please select at least one city for perishable items.');
   ...
   $(document).ready(function () {
            // Change event handler for sgst dropdown
