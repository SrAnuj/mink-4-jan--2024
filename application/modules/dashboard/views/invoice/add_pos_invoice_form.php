            ...
            <div class="tab-pane fade active in" id="home">
                <div class="row">
                                                ...
                                                <div
                                                    ...
                                                    <div class="panel-footer border-0 bg-white">
                                                        <h3 class="item-details-title">
                                                            <?php echo html_escape($product->product_name . '-(' . $product->cgst) . ')' ?>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-sm-12 col-md-7">
                        ...
                        <?php echo form_open_multipart('dashboard/Cinvoice/insert_posInvoice', array('class' => 'form-vertical', 'id' => '')) ?>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="form-group">
                                    <select id="store_id" class="form-control" name="store_id" required="">
                                        ...
                                        ?>
                                        <option selected value="<?php echo html_escape($store->store_id) ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group row guifooterpanel">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-7 col-lg-7 col-xl-6">
                                                <input type="text" id="invoice_discount" 
									...
									<div class="form-group row guifooterpanel">
                                        <div class="col-sm-12">
                                            <label for="date"
                                                class="col-sm-5 col-lg-5 col-xl-6 col-form-label"><?php echo display('discount_type') ?>:</label>
                                            <div class="col-sm-7 col-lg-7 col-xl-6">
                                                <select id="discount_t" class="form-control text-right" name="discount_type">
                            ...
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo form_open('dashboard/Cinvoice/update_status/' . $invoice['invoice_id'], array('id' => '')); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-sm-3 col-form-label"><?php echo display('password') ?> <i
                                class="text-danger">*</i></label>
                        <div class="col-sm-6">
					...
					<div class="form-group row">
					 ...
					 <div class="form-group row">
                            <label for="previous_balance"
                                class="col-sm-3 col-form-label">Previous Balance</label>
                            <div class="col-sm-6">
                ...
                <div class="modal-body">
					...
					<div class="form-group row">
                        <label for="discount_type"
                            class="col-sm-4 col-form-label"><?php echo display('discount_type') ?></label>
                        <div class="col-sm-8">
                            <select id="discountType" class="form-control" name="discount_type">
								<option value="fixed">Fixed Amount</option>
								<option value="percentage">Percentage</option>
							</select>
                        </div>
...
$("#discount_t").on("change", function () {
	
    var discountType = $(this).val(); // Get the selected discount type
    calculateSum(discountType); // Pass the discountType to the function
});
</script>