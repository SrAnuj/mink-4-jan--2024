                            ...
                            <div class="row">
                                <div class="col-sm-6 cominfo_div" style="float: left;">
                                    ...
                                    <address class="mt_10">
                                        ...
                                        <div> <?php echo display('address') ?> :<?php echo html_escape($company_info[0]['address']); ?> 
                                           </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if (!empty($item_tax)) {
                                                            ...
                                                            echo  html_escape($invoice['sgst']+$invoice['cgst']+$invoice['igst']) .'%';
                                                        } ?></td>

                                            <td>
                                                <?php
                                                     
                                                            echo   html_escape(($invoice['sgst'] *$invoice['rate']*$invoice['quantity']/100) + ($invoice['cgst'] *$invoice['rate']*$invoice['quantity']/100)) . " " . $currency  ?>
                                            </td>
                                        ...
                                        <?php
                                                ...
                                                $grand_total_tax =($invoice['sgst'] *$invoice['rate']*$invoice['quantity']/100) + ($invoice['cgst'] *$invoice['rate']*$invoice['quantity']/100);
                                                ?>
                                        <?php }
                                        } ?>
                                    </tbody>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="width_30p ft_left">
                                        ...
                                        <table class="table">
                                            ...
                                            <?php } else { ?>
                                                                                        <tr>
                                                <th class="grand_total">Total  Tax</th>
                                                <td class="grand_total">
                                                    <?php echo $invoice_all_data[0]['total_vat']. " " . $currency ?>
                                                </td>
                                            </tr>
                                            <tr>
