                                ...
                                <tbody>
									...
									if ($orders_list) {
										foreach ($orders_list as $key => $order) {
											...
											$orders_remarks_list = $CI->Orders->order_remarks_list($order['order']);
											//print_r($orders_remarks_list[0]['remarks']);die;
                                    ...
                                    <tr>
										...
										<td class="text-center">
                                            <?php
											if($orders_remarks_list[0]['status'] == 'Completed' || $orders_remarks_list[0]['status'] == 'Incompleted')
											{
												echo '<img id="imagePreview' . ($key + 1) . '" src="' . base_url($orders_remarks_list[0]['report_file']) . '" alt="' . ($key + 1) . '" style="max-width: 150px; max-height: 150px;" onerror="handleImageError()"><br/>';
												echo $orders_remarks_list[0]['remarks'];
											}else{
												echo "N/A";
											}
											?>
										...
										<td class="text-center">
											<?php echo $order['delivery_zone'] ?? 'N/A'; ?>
										</td>
                                        <td>
                                            <center>
                                                <?php echo form_open() ?>
