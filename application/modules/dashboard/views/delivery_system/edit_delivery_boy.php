                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="email" value="<?php echo html_escape($delivery_boy_info['email']) ?>" id="email"
                         ...
                         <div class="form-group row">
                            <label for="password" class="col-sm-3 col-form-label"><?php echo display('password') ?>
                                <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name="password" value="<?php echo html_escape($delivery_boy_info['password'])?>" id="password"
