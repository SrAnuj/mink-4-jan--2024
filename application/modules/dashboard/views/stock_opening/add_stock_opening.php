                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="3" class="form-control"
                                            value="<?php echo html_escape($voucher_no) ?>" name="voucher_no"
                                            placeholder="<?php echo display('voucher_no') ?>" id="voucher_no"
                                            required />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="date"
                                        class="col-sm-4 col-form-label"><?php echo display('voucher_date') ?>
                                        <i class="text-danger">*</i>
                                    </label>
                                    <div class="col-sm-8">
                                        <?php $date = date('m-d-Y'); ?>
                                        <input type="text" tabindex="3" class="form-control datepicker"
                                            name="voucher_date" value="<?php echo html_escape($date); ?>" id="date"
                                            required />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6" id="-store_hide">
                                <div class="form-group row">
                                    <label for="store_id"
                                        class="col-sm-4 col-form-label"><?php echo display('enter_to') ?>
                                        <i class="text-danger">*</i>
                                    </label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" tabindex="1" id="adress" name="voucher_detail"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="product_name" required
                                                ...
                                                placeholder="<?php echo display('product_name_or_item_code') ?>"
                                                id="product_name_1" tabindex="5" autocomplete="off">
                                        ...
                                        <td class="text-center">
                                         ...
                                         <td class="text-right">
                                            <input type="text" name="batch_no[]" required id="batch_no_1"
                                                class="form-control text-right"  placeholder="0"  value="<?= $batch_no; ?>">
                                        </td>
                                        <td class="text-right">
                                        ...
                                        <td class="text-right">
                                            <input type="number" name="product_quantity[]" id="total_qntt_1"
                                        ...
                                        <td>
                                            <input type="number" name="product_rate[]" id="price_item_1"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <input type="submit" id="add-stock-opening" class="btn btn-primary btn-large"
                                    name="add-stock-opening" value="<?php echo display('submit') ?>" />
                                <input type="submit" value="<?php echo display('submit_and_add_another') ?>"
                                    name="add-another-stock-opening" class="btn btn-large btn-success"
                                    id="add-stock-opening-another">
                            </div>
                        </div>
                        <?php echo form_close() ?>
                    </div>
