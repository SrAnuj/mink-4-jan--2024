...
<div class="col-sm-12">
    <div class="column">
      <a href="<?php echo base_url('dashboard/Cproduct/manage_subscription')?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo 'Manage subscription'?></a>
    </div>
</div>
</div>
...
<div class="col-sm-12">
    <div class="panel panel-bd lobidrag">
        ...
        <?php echo form_open_multipart('dashboard/subscription/insert_subscription',array('class' => 'form-vertical', 'id' => 'validate'))?>
