        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php } ?>
                   ...
                   <a class="btn btn-success  m-b-5 m-r-2" href="<?= base_url('dashboard/store-reports') ?>" target="_blank">Store Target Report</a>
                ...
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('dashboard/Cstore/insert_store', array('class' => 'form-vertical','id' => 'validate'))?>
                    <div class="panel-body">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" id="target_value"  name="target_value" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-3 col-form-label" id="remarks_id">Target Remarks<i class="text-danger">*</i></label>
                        <div class="col-sm-6">
                           <textarea class="form-control" cols="2" rows="2" id="remarks_id"  name="remarks_value"></textarea>
                        </div>
                    </div>
