                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                <?php
                                if ($sales_manager_target) {
                                    foreach ($sales_manager_target as $user) {
                                ?>
                                    <tr>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                ...
                                <?php
                                if ($sales_executive) {
                                    foreach ($sales_executive as $userArray) {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                            <a  class="btn btn-info btn-sm" data-placement="left" title="" data-original-title="Add target" data-toggle="modal"
                                             onclick="openDynamicModal('<?php echo $user['user_id']; ?>')"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                            </center>
                                        </td>
                                    </tr>
                                <?php } } ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h1 class="modal-title">Dynamic Modal</h1>
            </div>
        ...
        modal.innerHTML = `
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Modal content goes here -->
                        <p>This is the modal with ID ${dynamicID}</p>
                    </div>
                    <div class="modal-footer">
