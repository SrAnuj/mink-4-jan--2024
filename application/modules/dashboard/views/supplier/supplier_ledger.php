		        ...
		        <div class="panel panel-bd lobidrag">
		            ...
		            <div class="panel-body">
						...
						<div class="ft_right mr_100">
							...
							<tr><td><?php echo display('previous_balance')?> </td> <td class="balance_txt"><?php if ($total_balance) { echo (($position==0)?"$currency {previous_balance}":"{previous_balance} $currency");} ?></td> </tr>
								<tr><td><?php echo display('debit_ammount')?> </td> 
								 <td><?php if ($total_debit) { echo (($position==0)?"$currency
									{total_debit}":"{total_debit} $currency");} ?></td></tr>
