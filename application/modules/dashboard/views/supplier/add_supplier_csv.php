        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                       <a href="<?php echo base_url('assets/data/csv/supplier_csv_sample.csv') ?>" class="btn btn-primary  pull-right"   download="supplier_csv_sample.csv"><i class="fa fa-download"></i> 
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('import_supplier_csv') ?></h4>
                        </div>
                    </div>
                     <?php echo form_open_multipart('dashboard/Csupplier/uploadCsv',array('class' => 'form-vertical', 'id' => 'validate','name' => 'insert_supplier'))?>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <input type="submit" id="add-supplier" class="btn btn-primary btn-large" name="add-supplier" value="<?php echo display('submit') ?>" />
                                <input type="submit" value="<?php echo display('submit_and_add_another') ?>" name="add-supplier-another" class="btn btn-large btn-success color4" id="add-supplier-another">
                            </div>
                        </div>
                    </div>
                    <?php echo form_close()?>
