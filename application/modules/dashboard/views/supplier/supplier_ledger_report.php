                        ...
                        <div class="ft_right mr_100">
                            <table class="table table-striped table-condensed table-bordered">
								...
								<tr>
                                    ...
                                    <td class="balance_txt">
                                        <?php if ($previous_balance) {
                                                echo (($previous_balance == 0) ? "$currency {previous_balance}" : "{previous_balance} $currency");
                                            } else {
                                                echo (($position == 0) ? "$currency 00" : " 00 $currency");
                                            } ?>
                                    </td>
                            ...
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if (!empty($transaction_info)) {
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo html_escape($total_sup_balance); ?></td>
