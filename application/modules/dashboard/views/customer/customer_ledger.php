		        ...
		        <div class="panel panel-bd lobidrag">
		            ...
		            <div class="panel-body">
						 ...
						 <div class="ft_left">
							...
							<br>
							<?php echo display('delivery_zone') ?> : <?php echo html_escape($delivery_zone) ?? 'N/A'; ?><br>
						...
						<div class="ft_right mr_50">
							...
							<tr><td> <?php echo display('previous_balance') ?> </td> <td class="text-right mr_20"> <?php echo html_escape($previous_balance." ".$currency); ?></td> </tr>
