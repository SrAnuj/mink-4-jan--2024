...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('import_customer_csv') ?></h1>
            <small><?php echo display('import_customer_csv') ?></small>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url('')?>"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="<?php echo base_url('dashboard/Csupplier')?>"><?php echo display('supplier') ?></a></li>
                <li class="active"><?php echo display('import_customer_csv') ?></li>
            </ol>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                       <a href="<?php echo base_url('assets/data/csv/customer_csv_sample.csv') ?>" class="btn btn-primary  pull-right"   download="customer_csv_sample.csv"><i class="fa fa-download"></i> 
                        <?php echo display('download_sample_file')?>
                       </a>
                            <span class="text-warning">The first line in downloaded csv file should remain as it is. Please do not change the order of columns.</span><br>The correct column order is <span class="text-info">(supplier_name*,mobile*,email,vat_no,cin*,pan,cfssai,sfssai,address*,details,previous_balance,bank_account,account_no,ifsc,account_type,bank_name,branch,status
                                 separated by vertical bar)</span> &amp; you must follow this.<br>Please make sure the csv file is UTF-8 encoded and not saved with byte order mark (BOM).
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('import_customer_csv') ?></h4>
                        </div>
                    </div>
                     <?php echo form_open_multipart('dashboard/Ccustomer/uploadCsv',array('class' => 'form-vertical', 'id' => 'validate','name' => 'insert_supplier'))?>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <input type="submit" id="add-supplier" class="btn btn-primary btn-large" name="add-customer" value="<?php echo display('submit') ?>" />
                                <input type="submit" value="<?php echo display('submit_and_add_another') ?>" name="add-customer-another" class="btn btn-large btn-success color4" id="add-supplier-another">
                            </div>
                        </div>
                    </div>
                    <?php echo form_close()?>
