            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <?php echo form_open("dashboard/Ccustomer/customer_ledger_report", array('class' => 'form-inline','method' => 'post')); ?>
                        ...
                        <div class="ft_right_mr_100">
							...
							<tr>
                                    ...
                                    <td class="ta_right_mr_20">
                                        <?php echo (($position == 0) ? "$currency {previous_balance}" : "{previous_balance} $currency") ?>
                                    </td>
                                </tr>
                                <tr>
