                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" tabindex="6" name="user_type" id="user_type" required>
                                    ...
                                    <option value="5"><?php echo "Delivery Boy" ?></option>
                                    <option value="6"><?php echo "Retailer" ?></option>
                                    <option value="7"><?php echo "Wholesaler" ?></option>
                        ...
                        <div class="form-group row" id="payment_from_1" >
                         ...
                         <div class="form-group row" id="delevery_from_1" >
                            <label for="store" class="col-sm-3 col-form-label"><?php echo "delivery boys" ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <select class="form-control width_100p" name="delivery_id" id="delivery_id" required="">
								    <option value=""></option>
                                    {delivery_boys}
