    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview <?php if ($this->uri->segment(2) == ("Ccustomer")) {
            ...
            <ul class="treeview-menu">
                ...
                <?php }
                          if ($this->permission->check_label('import_customer_csv')->access()) { ?>
                <li class="<?php echo (($this->uri->segment(3) == 'add_customer_csv' ? 'active' : '')) ?>">
                    <a
                        href="<?php echo base_url('dashboard/Ccustomer/add_customer_csv') ?>"><?php echo display('import_customer_csv') ?></a>
                </li>
                <?php }
        ...
        <li class="treeview <?php if ($this->uri->segment(2) == ("Csupplier")) {
            ...
            <ul class="treeview-menu">
                ...
                <?php }
                  ...
                  if ($this->permission->check_label('import_supplier_csv')->access()) { ?>
                <li class="<?php echo (($this->uri->segment(3) == 'add_supplier_csv' ? 'active' : '')) ?>">
                    <a
                        href="<?php echo base_url('dashboard/Csupplier/add_supplier_csv') ?>"><?php echo display('import_supplier_csv') ?></a>
                </li>
                <?php }
                ...
                <li class="<?php echo (($this->uri->segment(3) == 'supplier_tax_report' ? 'active' : '')) ?>">
                    <a
                        href="<?php echo base_url('dashboard/Csupplier/supplier_tax_report') ?>"><?php echo display('supplier_tax_report') ?></a>
                </li>
        ...
        <li class="treeview active">
            <a href="#">
                <i class="ti-user"></i><span>Subscription </span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                ...
                <li class=" active ">
                    <a
                        href="<?php echo base_url('dashboard/Cproduct/manage_subscription') ?>">Manage Subscription</a>
                </li>
		...
		<?php endif;?>
<!-- retailer munu start   -->
<?php if ($this->permission->module('retailer')->access()) { ?>
        <li class="treeview <?php if ($this->uri->segment(2) == ("Cretailer")) {
                                        echo "active";
                                    } else {
                                        echo " ";
                                    } ?>">
            <a href="#">
                <i class="ti-user"></i><span>Retailer </span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <?php if ($this->permission->check_label('add_retailer')->access()) { ?>
                <li
                    class="<?php echo (($this->uri->segment(2) == 'Cretailer' && ($this->uri->segment(3) == '') ? 'active' : '')) ?>">
                    <a href="<?php echo base_url('dashboard/Cretailer') ?>">add_retailer</a>
                </li>
                <?php }
                        if ($this->permission->check_label('manage_supplier')->access()) { ?>
                <li class="<?php echo (($this->uri->segment(3) == 'manage_retailer' ? 'active' : '')) ?>">
                    <a
                        href="<?php echo base_url('dashboard/Cretailer/manage_retailer') ?>">manage_retailer</a>
                </li>
                <?php }
                     ?>
            </ul> 
...
<?php if ($this->permission->module('supplier')->access()) { ?>
        <li class="treeview <?php if ($this->uri->segment(2) == ("Cwholesaler")) {
                                        echo "active";
                                    } else {
                                        echo " ";
                                    } ?>">
            <a href="#">
                <i class="ti-user"></i><span>Wholesaler</span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <?php if ($this->permission->check_label('add_retailer')->access()) { ?>
                <li
                    class="<?php echo (($this->uri->segment(2) == 'Cwholesaler' && ($this->uri->segment(3) == '') ? 'active' : '')) ?>">
                    <a href="<?php echo base_url('dashboard/Cwholesaler') ?>">add_Wholesaler</a>
                </li>
                <?php }
                        if ($this->permission->check_label('manage_supplier')->access()) { ?>
                <li class="<?php echo (($this->uri->segment(3) == 'manage_retailer' ? 'active' : '')) ?>">
                    <a
                        href="<?php echo base_url('dashboard/Cwholesaler/manage_wholesaler') ?>">manage_Wholesaler</a>
                </li>
                <?php }
                     ?>
            </ul> 
...
<?php if ($this->permission->module('quotation')->access()) { ?>
        ...
        <li class="treeview <?php if ($this->uri->segment(2) == ("Cpurchase") || $this->uri->segment(2) == ("Cpurchase_return")) {
            ...
            <ul class="treeview-menu">
                ...
                <li class="<?php echo (($this->uri->segment(3) == 'manage_purchase' ? 'active' : '')) ?>">
                  ...
                  <?php }
                        if ($this->permission->check_label('purchase_excel_import')->access()) { ?>
                <li class="<?php echo (($this->uri->segment(3) == 'purchase_excel_import' ? 'active' : '')) ?>">
                    <a
                        href="<?php echo base_url('dashboard/Cpurchase/purchase_excel_import') ?>"><?php echo display('import_purchase_excel') ?></a>
                </li>
                <?php }
    ...
    ************************************* -->
        ...
        <li>
            <a href="mailto:Manager@premierwebtech.com"> <i class="ti-themify-favicon"></i><span>Support</span>
