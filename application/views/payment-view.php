...
<p>Mobile : <?php echo $customerdata->customer_mobile; ?></p>
<p>Address : <?php echo $customerdata->customer_address_1; ?></p>
...
<form method="post" action="<?php echo base_url('payment/checkout');?>">
	<div class="form-group">
		...
		<input type="hidden" name="customer_mobileno" value="<?php echo $customerdata->customer_mobile; ?>" />
		<input type="hidden" name="customer_address" value="<?php echo $customerdata->customer_address_1; ?>" />
