...
$route['tag/(:any)'] = 'web/Category/category_product/$1';
...
$route['user_subscription'] = 'web/customer/Signup/user_subscription';
...
$route['customer/subscription'] = 'web/customer/Corder/new_subscription';
$route['customer/subscription/manage_subscription'] = 'web/customer/Corder/manage_subscription';
$route['customer/subscription/insert_subscription'] = 'web/customer/Corder/insert_subscription';
$route['customer/vacational'] = 'web/customer/Corder/vacational_mode';
...
$route['delivery_dashboard'] = 'delivery_man/customer/Delivery_dashboard';

$route['delivery/login'] = 'delivery_man/customer/Delivery_auth';
$route['assign_deliveries'] = 'delivery_man/customer/Delivery_auth/manage_assigned_delivery';

$route['edit_assign_deliveries'] = 'delivery_man/customer/Delivery_dashboard/edit_assigned_delivery';
$route['assigned_delivery_delete'] = 'delivery_man/customer/Delivery_dashboard/assigned_delivery_delete';
$route['delivery_auth'] = 'delivery_man/customer/Delivery_dashboard/delivery_auth';
$route['delivery_logout'] = 'delivery_man/customer/Delivery_dashboard/delivery_logout';
$route['delivery/delivery_dashboard/edit_profile'] = 'delivery_man/customer/Delivery_dashboard/edit_profile';




// dashboard/delivery/controllers/customer/
// delivery man ends
//Link page 
...
$route['franchise'] = 'web/Setting/franchise';
$route['submit_franchise'] = 'web/Setting/submit_franchise';
$route['all_products'] = 'web/Setting/all_products';
...
$route['/subscription'] = 'dashboard/Cproduct/manage_subscription';
$route['dashboard/subscription/add_new'] = 'dashboard/Cproduct/new_subscription';
$route['dashboard/subscription/insert_subscription'] = 'dashboard/Cproduct/insert_subscription';
...
$route['cashfree_payment_success'] = 'web/home/cashfree_payment_success';

//Admin Dashboard End {Ram Anuj Code}
$route['getCity/(:any)'] = 'web/Home/getStateCity/$1';
$route['notification/mark_as_read/(:num)'] = 'dashboard/NotificationController/markAsRead/$1';
$route['notification/show_all_notification/(:num)'] = 'dashboard/NotificationController/showAllNotifications/$1';

$route['notification/remove_notification/(:num)'] = 'dashboard/NotificationController/removeNotification/$1';
$route['cstore/remove_store_target'] = 'dashboard/Cstore/delete_store_target';
$route['dashboard/store-reports'] = 'dashboard/StoreReport/getStoreReports';
$route['product/remove_location'] = 'dashboard/Cproduct/delete_locations';
$route['dashboard/user-targets'] = 'dashboard/Admin_dashboard/getUserRoleTarget';
// Role
//Admin Dashboard {Ram Anuj Code}
