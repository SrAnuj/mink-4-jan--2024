...
function quantity_calculate(item) {
    ...
    var plannedDaysValue = document.getElementById('plannedDays').value;
	var matches = plannedDaysValue.match(/\d+/); // This will find the first sequence of digits

	// Check if a match was found and get the number of days
	var plan = matches ? matches[0] : null;
    ...
    var net_price = (quantity * price_item*plan) - all_discount;
