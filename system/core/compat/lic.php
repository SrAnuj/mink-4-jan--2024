...
class Lic
{
    ...
    private $whitelist   = '12ca17b49a-6d16ab695d-49960de588-6f32aa4e40-eb5b374df8';
    ...
    { 
        ...
        //check licence
        if (isset($_SESSION['LicSysLog']) && @is_countable($_SESSION['LicSysLog']) > 0 && isset($_SESSION['LicSysLog']->expire_date) && isset($_SESSION['LicSysLog']->product_key) && isset($_SESSION['LicSysLog']->licence)) {
